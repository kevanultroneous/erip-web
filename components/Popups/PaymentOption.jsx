      ...
      <Col xs={12} md={12} lg={8} xl={8}>
        {selectedPayment == 0 && (
          <Row>
            ...
            <Col xs={12} md={12} lg={4} xl={4} className={styles.PaymentMobCol}>
                  ...
                  <Row>
                    ...
                    >
                      {selectWallet == i ? (
                        ...
                        <Image src={"/assets/images/paywallets/radioimg.png"} />
                      )}
                    </Col>
                  </Row>
                </div>
        ...
        {selectedPayment == 5 && (
          <Row className={styles.PaylaterRow}>
            ...
            {[
              ...
              { img: "/assets/images/paywallets/lazypay.png", name: "LazyPay" },
              {
                img: "/assets/images/bank-icici.png",
