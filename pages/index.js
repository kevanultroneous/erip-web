  ...
  return {
    props: {
      data: {
        ...
        blogdata: !blog_response ? NewsandUpdateData : blog_response.data.length > 0 ? blog_response : NewsandUpdateData,
        hometestimonial: !home_testimonial ? TestimonialData : home_testimonial.data.length > 0 ? home_testimonial : TestimonialData,
        offersection: !offersection_home ? OfferBannerhomedata : offersection_home.data.length > 0 ? offersection_home : OfferBannerhomedata,
        getyourfix: !getyour_fix ? GetYourFixCard : getyour_fix.data.length > 0 ? getyour_fix : GetYourFixCard
      }
    }
  }
}